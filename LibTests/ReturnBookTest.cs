...
namespace LibTests
{
    ...
    public class ReturnBookTest
    {
        ...
        public void ReaderIdIsNull()
        {
            ...
            // Act and assert
            Assert.ThrowsException<System.ArgumentNullException>(() => service.ReturnBook(null, 5));
        }
        ...
        public void BookIdIsNull()
        {
            ...
            // Act and assert
            Assert.ThrowsException<System.ArgumentNullException>(() => service.ReturnBook(5, null));
        }
        ...
        public void ReaderIsNotFound()
        {
            ...
            // Act and assert
            Assert.ThrowsException<System.InvalidOperationException>(() => service.ReturnBook(1, 1));
        }
